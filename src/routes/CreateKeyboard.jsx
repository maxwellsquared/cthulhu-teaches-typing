...
function CreateKeyboard() {
      ...
      <div className="flex min-h-full flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="mb-10 w-full max-w-md space-y-8">
          <form
            ...
            autoComplete="off"
          >
            <div className="space-y-px rounded-md shadow-sm text-cosmic-purple dark:text-pale-gold">
              <div>
                <input
                  type="text"
                  name="keyboard"
 ...
 onChange={(event) => {
  setKeyboardType(event.target.value);
                ...
                />
                <label for="color1">Base Colour</label>
                ...
                />
                <label for="color2">Keycap Colour</label>
                </div>
              </div>
            </div>

            <button
              className="group relative flex transform items-center justify-center gap-3 rounded-md border border-transparent bg-darker-beige px-6 text-lg font-medium text-dark-navy transition duration-300 ease-in-out hover:scale-105 hover:bg-kinda-teal focus:outline-none focus:ring-2 focus:ring-blood-red focus:ring-offset-2 dark:bg-pale-gold  dark:text-cosmic-purple dark:hover:bg-gold-hover"
              onClick={() => {
